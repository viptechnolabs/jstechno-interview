            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    @endif
                        ...
                        @endif
                    <form class="" action="{{ route('position.update') }}" method="POST" novalidate>
                        @csrf
                        @method('put')
                        ...
                        <div class="field item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input class="form-control" data-validate-length-range="6" data-validate-words="1" name="name" value="{{ $position->name }}" placeholder="ex. John f. Kennedy" required="required" />
                            </div>
                        </div>
                        <div class="field item form-group">
